...
pip3 install --no-cache-dir --verbose build==1.2.2 scikit-build -i https://pypi.tuna.tsinghua.edu.cn/simple

python3 setup.py build_ext --inplace
python3 -m build --sdist --wheel --outdir ${PIP_WHEEL_DIR}

pip3 install --no-cache-dir --verbose ${PIP_WHEEL_DIR}/piper_tts*.whl -i https://pypi.tuna.tsinghua.edu.cn/simple
pip3 show piper-tts
